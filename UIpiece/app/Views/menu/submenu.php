...
<body>
    <div class="flex min-h-screen">
        <div class="flex h-screen sticky top-0 z-50 w-16 flex-col justify-between border-e bg-white">
            <div>
        ...
        <div class="flex h-screen sticky top-0 z-50 justify-between border-t bg-white hidden" id="mobile-menu">
            <div class="px-4 py-6">
        ...
        <div class="flex-1 border-e bg-white">
            ...
            <div class="flex-1 border-e bg-white">
                ...
                <div class="flex m-4">
                    <fieldset class="flex flex-wrap gap-3 p-3">
                        ...
                        <label for="ColorBlack"
                            ...
                            <input type="radio" name="ColorOption" value="ColorBlack" id="ColorBlack" class="sr-only"
                                checked />
                    ...
                    <span class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm ml-3">
                        <button
